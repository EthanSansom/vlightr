...
elements. So a list, which can contain elements of varying sizes, is
non-highlightable (although a list can contain highlighted vectors).
...
TODO Add: - some examples from lubridate and ivs - what CAN'T you
highlight -\> data frames and bare lists - demonstrate the use of the
`init_formatter` to add better default formatting, with a lubridate
ymd_hms interval (interval(now(), now()) is super long, truncate)
