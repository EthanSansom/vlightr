...
this, these functions should are mostly useful for highlighting columns 
immediately before a tibble is printed.
...
co-workers or peers (the reason that the first version of vlightr was written).
