...
-   **Generic**, meaning that many vectors you'll encounter in the wild and all 
base atomic vectors (`"logical"`, `"integer"`, `"numeric"`, `"complex"`, `"character"` and `"raw"`) can be highlighted.
